...
test connection to the node curl -X POST --data '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":4142465097}' -H Content-Type: application/json http://localhost:9999
